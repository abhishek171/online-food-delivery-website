...
@Entity
@Table(name="customerfutureusedata")
public class CustomerDetailsFuture {
	...
	public CustomerDetailsFuture() {
		super();
	}
	public CustomerDetailsFuture(CustomerDetailsRequest customerDetailsRequest) {
		super();
	...
	public String toString() {
		return "CustomerDetailsFuture [custId= " + custId + " custName=" + custName + ", custPhone=" + custPhone
